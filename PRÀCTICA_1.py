...
class EmpleadoMedioTiempo(Empleado):
    ...
    def calcularSalario(self, horas_trabajadas):
...
class EmpleadoFreelance(Empleado):
     ...
     def calcularSalario(self, numero_proyectos, pago_por_proyecto):
         self.salario_base= self.salario_base+(self.numero_proyectos*self.pago_por_proyecto)
